    ...
    public class BillingMethodInvoke
    {
        ...
        public ResultSrv<List<InvoiceSrv>> GetInvoiceListByMetadata()
        {
            try
            {
                ...
                var getInvoiceListByMetadataVo = GetInvoiceListByMetadataVo.ConcreteBuilder
                    .SetServiceCallParameters(internalServiceCallVo)
                    .SetMetaQuery("{\"field\":\"name\",\"is\":\"test\"}")
                    //.SetSize(0)
                    //.SetOffSet("")
                    //.SetIsCanceled(false)
                    //.SetIsPayed(false)
        ...
        public ResultSrv<InvoiceSrv> ReduceInvoice()
        {
            try
            {
                ...
                var reduceInvoiceVo = ReduceInvoiceVo.ConcreteBuilder
                    ...
                    {
                        InvoiceItemInfoVo.ConcreteBuilder.SetInvoiceItemId(0).SetItemDescription("test").SetPrice(5).SetQuantity(1).Build(),
                        //InvoiceItemInfoVo.ConcreteBuilder.SetInvoiceItemId(0).SetItemDescription("test1").SetPrice(1700).SetQuantity(1).Build()
                    })
        ...
        public ResultSrv<List<ExportServiceSrv>> GetExportList()
        {
            try
            {
                ...
                var link = getExportListVo.GetLink(0, "");
                return output;
            }
            catch (PodException podException)
            {
        ...
        public ResultSrv<bool> PayInvoiceByInvoice()
        {
            try
            {
                ...
                var payInvoiceByInvoiceVo = PayInvoiceByInvoiceVo.ConcreteBuilder
                    .SetServiceCallParameters(internalServiceCallVo)
                    .SetCreditorInvoiceId(0)
                    .SetDebtorInvoiceId(0)
                    .Build();
        ...
        public LinkSrv CreatePreInvoice()
        {
            try
            {
                ...
                var createPreInvoiceVo = CreatePreInvoiceVo.ConcreteBuilder
                    .SetServiceCallParameters(internalServiceCallVo)
                    .SetApiToken(internalServiceCallVo.Token)
                    .SetOtt(ottOutput.Ott)
                    .SetProductsInfo(new List<ProductInfo>
                    {
                        ProductInfo.ConcreteBuilder.SetProductId(0).SetPrice(1200).SetQuantity(3).SetProductDescription("test").Build(),
                        ProductInfo.ConcreteBuilder.SetProductId(0).SetPrice(1400).SetQuantity(3).SetProductDescription("test1").Build()
                    })
                    .SetGuildCode(GuildCode)
                    .SetRedirectUri("")
                    .SetUserId(0)
        ...
        public ResultSrv<InvoiceSrv> IssueMultiInvoice()
        {
            try
            {
                ...
                var mainInvoiceVos = MainInvoiceVo.ConcreteBuilder
                    ...
                    {
                        InvoiceItemVo.ConcreteBuilder.SetProductId(0).SetDescription("tst").SetPrice(100).SetQuantity(2).Build()
                    })
                    //.SetBillNumber("")
                    .SetDescription("test")
                    //.SetMetadata("")
                ...
                var subInvoiceVos = new List<SubInvoiceVo>
                {
                    SubInvoiceVo.ConcreteBuilder
                        ...
                        .SetInvoiceItemVOs(new List<InvoiceItemVo>
                        {
                            InvoiceItemVo.ConcreteBuilder.SetProductId(0).SetDescription("tst1").SetPrice(100).SetQuantity(2).Build()
                        })
                        //.SetBillNumber("")
                        .SetDescription("")
                        //.SetMetadata("")
        ...
        public ResultSrv<InvoiceSrv> ReduceMultiInvoice()
        {
            try
            {
                ...
                var mainInvoiceVos = ReduceInvoiceItemVo.ConcreteBuilder
                    ...
                    {
                        ReduceInvoiceSubItemVo.ConcreteBuilder.SetId(0).SetDescription("").SetPrice(5)
                            .SetQuantity(0).Build()
                    })
                    .Build();
                ...
                {
                    ReduceInvoiceSubItemVo.ConcreteBuilder.SetId(0).SetDescription("tst").SetPrice(10).SetQuantity(1)
                        .Build()
                };
        ...
        public ResultSrv<InvoiceSrv> ReduceMultiInvoiceAndCashout()
        {
            try
            {
                ...
                var mainInvoiceVos = ReduceInvoiceItemVo.ConcreteBuilder
                    ...
                    .SetReduceInvoiceItemVOs(new List<ReduceInvoiceSubItemVo>
                    {
                        ReduceInvoiceSubItemVo.ConcreteBuilder.SetId(0).SetDescription("tst").SetPrice(50)
                            .SetQuantity(2).Build()
                    })
                    .Build();
