...
namespace POD_Billing.Model.ValueObject.Voucher
{
    public class VoucherContentVo
    {
        ...
        public VoucherContentVo(Builder builder)
        {
        ...
        public class Builder
        {
            ...
            public VoucherContentVo Build()
            {
                ...
                return new VoucherContentVo(this);
            }
        }
        public static KeyValuePair<string, string> ValidateHashCodeCount(List<VoucherContentVo> vouchersContent)
        {
