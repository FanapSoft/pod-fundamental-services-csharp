...
{
    public class UpdateMultiProductVo:ProductVo
    {
        ...
        public UpdateMultiProductVo(Builder builder) : base(builder)
        {
        ...
        public class Builder:ProductVo
        {
            ...
            public UpdateMultiProductVo Build()
            {
                ...
                return new UpdateMultiProductVo(this);
            }
        }
    }
}
