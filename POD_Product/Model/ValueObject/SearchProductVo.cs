...
namespace POD_Product.Model.ValueObject
{
    public class SearchProductVo
    {
        ...
        public string[] CategoryCodes { get; }
        ...
        public SearchProductVo(Builder builder)
        {
            BusinessId = builder.GetBusinessId();
            Id = builder.GetId();
            UniqueId = builder.GetUniqueId();
            CategoryCodes = builder.GetCategoryCode();
        ...
        public class Builder
        {
            ...
            /// <param name="categoryCodes">لیست کد دسته یندی محصول</param>
            public Builder SetCategoryCode(string[] categoryCodes)
            {
            ...
            public SearchProductVo Build()
            {
                ...
                return new SearchProductVo(this);
            }
        }
    }
}
